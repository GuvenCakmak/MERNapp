...
const EditEmployee = () => {
  ...
  let history = useHistory(); //The useHistory hook access to the history instance to navigate.
  const { id } = useParams();  //The useParams() hook to access the URL parameters from a current route. 
